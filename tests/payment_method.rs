...
mod tests {
    ...
    use xendit::{client::XenditClient, payment_method::{payment_method_parameters::{EWalletParameter, PaymentType, Reusability, VirtualAccountParameter, VirtualAccountParameterUpdate}, GetPaymentMethodsParams, PaymentChannel::{EWallet, VirtualAccount}, PaymentMethodBody, PaymentMethodClient, PaymentMethodUpdateBody, PaymentStatus}};
    ...
    async fn create_payment_method_ewallet() {
        ...
        let body = PaymentMethodBody::new(PaymentType::Ewallet, Reusability::OneTimeUse)
            ...
            .set_ewallet(EWalletParameter::new(
                EWallet::Ovo)
    ...
    async fn create_payment_method_va() {
        ...
        let body = PaymentMethodBody::new(PaymentType::VirtualAccount, Reusability::MultipleUse)
            .set_description(String::from("Payment for order #123"))
            .set_virtual_account(VirtualAccountParameter::new(
                VirtualAccount::Bri)
                .set_amount(120000.0)
    ...
    async fn update_payment_method() {
        ...
        let updated_body = PaymentMethodUpdateBody::new()
            ...
            .set_virtual_account(VirtualAccountParameterUpdate::new()
                .set_amount(150000.0)
                .build())
            .build();
        assert!(
    ...
    async fn get_payments_by_payment_method_id() {
        ...
        let status = payment_method_client.simulate_payment(&payment_method.id, 120000.0).await.unwrap();
